This game is implemeted in c++. 
Enviroment : ubuntu 16.04LTS

Procedure to start:
	compile file tic_tac.cpp
	"Choose x or o" appears on the screen you can choose any one of them else an error appear showing wrong input.
...
Features :
	In tic_tac.cpp there is marcos SIZE whose value is 3 by default.
	change its value to any inter greater than 3(this value to be maintained by programmer so checks are present).
